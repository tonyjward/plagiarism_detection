...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type = int, default = 2, metavar = 'IN',
                       help = 'input dimensions for training (default: 2)')
    parser.add_argument('--hidden_dim', type = int, default = 100, metavar = 'HID',
                       help = 'hidden dimension for training (defualt: 100)')
